...
-- Records of t_dept
-- ----------------------------
INSERT INTO `t_dept` VALUES ('1', '0', '研发部', '1', '2019-06-14 20:56:41', '2020-07-14 08:39:02');
INSERT INTO `t_dept` VALUES ('2', '1', '研发一部', '1', '2019-06-14 20:58:46', '2020-07-14 08:39:11');
INSERT INTO `t_dept` VALUES ('3', '1', '研发二部', '2', '2019-06-14 20:58:56', '2020-07-14 08:39:19');
INSERT INTO `t_dept` VALUES ('4', '0', '设计部', '2', '2019-06-14 20:59:56', '2020-07-14 08:39:26');
...
INSERT INTO `t_dept` VALUES ('11', '0', '新媒体部', '3', '2020-07-14 08:40:03', null);
...
) ENGINE=MyISAM AUTO_INCREMENT=1019 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='操作日志表';

-- ----------------------------
-- Records of t_log
-- ----------------------------
INSERT INTO `t_log` VALUES ('1011', 'K', '修改部门', '13', 'cc.mrbird.febs.system.controller.DeptController.updateDept()', ' dept: \"Dept(deptId=1, parentId=0, deptName=设计部, orderNum=2, createTime=null, modifyTime=Tue Jul 14 08:37:55 CST 2020)\"', '192.168.1.105', '2020-07-14 08:37:55', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `t_log` VALUES ('1012', 'K', '修改部门', '13', 'cc.mrbird.febs.system.controller.DeptController.updateDept()', ' dept: \"Dept(deptId=1, parentId=0, deptName=设计部, orderNum=1, createTime=null, modifyTime=Tue Jul 14 08:38:06 CST 2020)\"', '192.168.1.105', '2020-07-14 08:38:07', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `t_log` VALUES ('1013', 'K', '修改部门', '13', 'cc.mrbird.febs.system.controller.DeptController.updateDept()', ' dept: \"Dept(deptId=2, parentId=1, deptName=研发部, orderNum=null, createTime=null, modifyTime=Tue Jul 14 08:38:50 CST 2020)\"', '192.168.1.105', '2020-07-14 08:38:50', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `t_log` VALUES ('1014', 'K', '修改部门', '12', 'cc.mrbird.febs.system.controller.DeptController.updateDept()', ' dept: \"Dept(deptId=1, parentId=0, deptName=研发部, orderNum=1, createTime=null, modifyTime=Tue Jul 14 08:39:02 CST 2020)\"', '192.168.1.105', '2020-07-14 08:39:02', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `t_log` VALUES ('1015', 'K', '修改部门', '12', 'cc.mrbird.febs.system.controller.DeptController.updateDept()', ' dept: \"Dept(deptId=2, parentId=1, deptName=研发一部, orderNum=1, createTime=null, modifyTime=Tue Jul 14 08:39:10 CST 2020)\"', '192.168.1.105', '2020-07-14 08:39:11', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `t_log` VALUES ('1016', 'K', '修改部门', '12', 'cc.mrbird.febs.system.controller.DeptController.updateDept()', ' dept: \"Dept(deptId=3, parentId=1, deptName=研发二部, orderNum=2, createTime=null, modifyTime=Tue Jul 14 08:39:18 CST 2020)\"', '192.168.1.105', '2020-07-14 08:39:19', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `t_log` VALUES ('1017', 'K', '修改部门', '6', 'cc.mrbird.febs.system.controller.DeptController.updateDept()', ' dept: \"Dept(deptId=4, parentId=0, deptName=设计部, orderNum=2, createTime=null, modifyTime=Tue Jul 14 08:39:26 CST 2020)\"', '192.168.1.105', '2020-07-14 08:39:26', '内网IP|0|0|内网IP|内网IP');
INSERT INTO `t_log` VALUES ('1018', 'K', '新增部门', '12', 'cc.mrbird.febs.system.controller.DeptController.addDept()', ' dept: \"Dept(deptId=11, parentId=0, deptName=新媒体部, orderNum=3, createTime=Tue Jul 14 08:40:03 CST 2020, modifyTime=null)\"', '192.168.1.105', '2020-07-14 08:40:03', '内网IP|0|0|内网IP|内网IP');
...
) ENGINE=MyISAM AUTO_INCREMENT=105 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='登录日志表';

-- ----------------------------
-- Records of t_login_log
-- ----------------------------
INSERT INTO `t_login_log` VALUES ('70', 'scott', '2020-06-25 18:20:55', null, '192.168.1.105', 'Windows 10', 'Chrome 83');
INSERT INTO `t_login_log` VALUES ('71', 'Khighness', '2020-06-25 18:23:01', null, '192.168.1.105', 'Windows 10', 'Chrome 83');
INSERT INTO `t_login_log` VALUES ('72', 'mrbird', '2020-06-25 18:24:58', null, '192.168.1.105', 'Windows 10', 'Chrome 83');
INSERT INTO `t_login_log` VALUES ('73', 'Khighness', '2020-06-25 18:25:37', null, '192.168.1.105', 'Windows 10', 'Chrome 83');
INSERT INTO `t_login_log` VALUES ('74', 'mrbird', '2020-06-25 18:25:58', null, '192.168.1.105', 'Windows 10', 'Chrome 83');
INSERT INTO `t_login_log` VALUES ('75', 'Khighness', '2020-06-25 18:31:18', null, '192.168.1.105', 'Windows 10', 'Chrome 83');
INSERT INTO `t_login_log` VALUES ('76', 'Khighness', '2020-06-29 16:14:17', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Chrome 83');
INSERT INTO `t_login_log` VALUES ('77', 'Khighness', '2020-07-12 18:02:46', '内网IP|0|0|内网IP|内网IP', '192.168.1.105', 'Windows 10', 'Chrome 83');
INSERT INTO `t_login_log` VALUES ('78', 'Khighness', '2020-07-12 22:27:26', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Chrome 83');
INSERT INTO `t_login_log` VALUES ('79', 'K1', '2020-07-12 22:29:48', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Chrome 83');
INSERT INTO `t_login_log` VALUES ('80', 'Khighness', '2020-07-13 15:41:26', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Chrome 83');
INSERT INTO `t_login_log` VALUES ('81', 'Khighness', '2020-07-13 20:47:15', '内网IP|0|0|内网IP|内网IP', '192.168.1.105', 'Windows 10', 'Chrome 83');
INSERT INTO `t_login_log` VALUES ('82', 'MrBird', '2020-07-13 20:49:29', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Chrome 83');
INSERT INTO `t_login_log` VALUES ('83', 'K', '2020-07-13 20:51:34', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Chrome 83');
INSERT INTO `t_login_log` VALUES ('84', 'Khighness', '2020-07-13 21:23:34', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Chrome 83');
INSERT INTO `t_login_log` VALUES ('85', 'Khighness', '2020-07-13 23:31:15', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Chrome 83');
INSERT INTO `t_login_log` VALUES ('86', 'Khighness', '2020-07-13 23:48:37', '内网IP|0|0|内网IP|内网IP', '192.168.1.105', 'Windows 10', 'Chrome 83');
INSERT INTO `t_login_log` VALUES ('87', 'Khighness', '2020-07-14 00:29:44', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Chrome 83');
INSERT INTO `t_login_log` VALUES ('88', 'Khighness', '2020-07-14 01:30:15', '内网IP|0|0|内网IP|内网IP', '192.168.1.105', 'Windows 10', 'Chrome 83');
INSERT INTO `t_login_log` VALUES ('89', 'Khighness', '2020-07-14 01:32:20', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Chrome 83');
INSERT INTO `t_login_log` VALUES ('90', 'Khighness', '2020-07-14 01:38:32', '内网IP|0|0|内网IP|内网IP', '192.168.1.105', 'Windows 10', 'Chrome 83');
INSERT INTO `t_login_log` VALUES ('91', 'Khighness', '2020-07-14 08:22:26', '内网IP|0|0|内网IP|内网IP', '192.168.1.105', 'Windows 10', 'Chrome 83');
INSERT INTO `t_login_log` VALUES ('92', 'Khighness', '2020-07-14 08:35:59', '内网IP|0|0|内网IP|内网IP', '192.168.1.105', 'Windows 10', 'Chrome 83');
INSERT INTO `t_login_log` VALUES ('93', 'K', '2020-07-14 08:36:42', '内网IP|0|0|内网IP|内网IP', '192.168.1.105', 'Windows 10', 'Chrome 83');
INSERT INTO `t_login_log` VALUES ('94', 'Khighness', '2020-07-14 08:43:25', '内网IP|0|0|内网IP|内网IP', '192.168.1.105', 'Windows 10', 'Chrome 83');
INSERT INTO `t_login_log` VALUES ('95', 'Khighness', '2020-07-14 08:45:04', '内网IP|0|0|内网IP|内网IP', '192.168.1.105', 'Windows 10', 'Chrome 83');
INSERT INTO `t_login_log` VALUES ('96', 'Khighness', '2020-07-14 08:46:11', '内网IP|0|0|内网IP|内网IP', '192.168.1.105', 'Windows 10', 'Chrome 83');
INSERT INTO `t_login_log` VALUES ('97', 'Khighness', '2020-07-14 08:51:51', '内网IP|0|0|内网IP|内网IP', '192.168.1.105', 'Windows 10', 'Chrome 83');
INSERT INTO `t_login_log` VALUES ('98', 'Khighness', '2020-07-14 08:59:36', '内网IP|0|0|内网IP|内网IP', '192.168.1.105', 'Windows 10', 'Chrome 83');
INSERT INTO `t_login_log` VALUES ('99', 'K1', '2020-07-14 09:00:50', '内网IP|0|0|内网IP|内网IP', '127.0.0.1', 'Windows 10', 'Chrome 83');
INSERT INTO `t_login_log` VALUES ('100', 'Khighness', '2020-07-14 17:36:49', '内网IP|0|0|内网IP|内网IP', '192.168.1.105', 'Windows 10', 'Chrome 83');
INSERT INTO `t_login_log` VALUES ('101', 'Khighness', '2020-07-14 17:41:06', '内网IP|0|0|内网IP|内网IP', '192.168.1.105', 'Windows 10', 'Chrome 83');
INSERT INTO `t_login_log` VALUES ('102', 'Khighness', '2020-07-14 17:43:15', '内网IP|0|0|内网IP|内网IP', '192.168.1.105', 'Windows 10', 'Chrome 83');
INSERT INTO `t_login_log` VALUES ('103', 'Khighness', '2020-07-14 18:24:28', '内网IP|0|0|内网IP|内网IP', '192.168.1.105', 'Windows 10', 'Chrome 83');
INSERT INTO `t_login_log` VALUES ('104', 'Khighness', '2020-07-15 00:27:27', '内网IP|0|0|内网IP|内网IP', '192.168.1.105', 'Windows 10', 'Chrome 83');
...
-- Records of t_user
-- ----------------------------
INSERT INTO `t_user` VALUES ('1', 'K', '2e0b2e4d225e64803b702937b3224021', '1', 'mrbird@qq.com', '17788888888', '1', '2019-06-14 20:39:22', '2020-06-25 18:25:23', '2020-07-14 08:36:43', '0', '1', 'black', 'cnrhVkzwxjPwAaCfPbdc.png', '我是帅比作者。');
INSERT INTO `t_user` VALUES ('2', 'Scott', '1d685729d113cfd03872f154939bee1c', '10', 'scott@gmail.com', '17722222222', '1', '2019-06-14 20:55:53', '2019-06-14 21:05:43', '2020-06-25 18:20:56', '0', '1', 'black', 'gaOngJwsRYRaVAuXXcmB.png', '我是scott。');
...
INSERT INTO `t_user` VALUES ('8', 'Khighness', 'c9d2a880e29fc7849f0c03fe510fc942', '1', 'parakovo@gamil.com', '13611339958', '1', '2020-06-25 18:22:47', '2020-06-25 18:23:57', '2020-07-15 00:27:27', '0', '1', 'black', 'BiazfanxmamNRoxxVxka.png', 'K丫');
INSERT INTO `t_user` VALUES ('9', 'K1', '63fcf5bd98f174569fffd288588e357e', null, null, null, '1', '2020-07-12 22:29:36', null, '2020-07-14 09:00:51', '2', '1', 'black', 'default.jpg', '注册用户');
